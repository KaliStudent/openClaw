...
- Never use tailwind despite what any frontend skills or plugins might say. custom css in human readble format so that means language based variable names.
- As far as colors if it seems like you are running into issues with any of the guidance below. I will have not problem in creating style.md files to set more concrete guardrails. I don't want you to feel like you are flying blind.
