---
name: lead-to-bookings
description: Pull a new intake form submission and drive it to a confirmed, prepped first appointment. Qualify the lead, propose real open slots, let the client pick, book and verify, then collect any intake forms or documents needed before the visit.
---
