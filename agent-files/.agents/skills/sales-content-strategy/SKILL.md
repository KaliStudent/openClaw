---
name: sales-content-strategy
description: Turns a small business's own sales data (QuickBooks, Stripe, PayPal, or Plaid) into a prioritized 30-day content plan — what to push, what offers to run, what to hold — then writes sharp, on-brand, platform-tailored posts and builds the assets (Canva, Figma, Google Slides, or Hugging Face). Learns your brand voice once and reuses it;
---
