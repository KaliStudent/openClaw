...
description: Accessibility-first describing of images and videos for blind and low-vision users, delivered as BOTH a WhatsApp voice message and a shareable text. Adapts to the task, shopping list from a fridge, hazard check of a room, factual account of an incident, pet wellbeing, or a warm general description.
---
